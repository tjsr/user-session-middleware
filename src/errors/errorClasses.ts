...
export class SessionIdCookieInvalidError extends SessionHandlerError {
  constructor(message = 'Invalid session ID cookie provided.', cause?: unknown) {
    super(INVALID_SESSION_ID_COOKIE, HttpStatusCode.BAD_REQUEST, message, cause);
  }
}
...
export class SessionMiddlewareTestSetupError extends SessionMiddlewareError {
